...
builder.Services.AddSingleton<IPersonDatabaseAccess, PersonDbContext>();
builder.Services.AddSingleton<PersonService>();// Singleton: eine instanz für alle konsumenten
